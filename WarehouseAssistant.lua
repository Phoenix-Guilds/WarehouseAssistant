...
local accountCharacters = {  
    ...
    ["04"] = {"Мензурочка", "Бумажная", "Крошшерный", "Тернистая", "Красочка", "Карточка", "Свитковый", "Царапучка" --[[ , "Ларец" ]]},  
    ["05"] = {"Складочка", "Приёмка", "Принимающий", "Забирающий"--[[ , "Пылящая", "Осколочная", "Замерзшая", "Нзешечка" ]]},  
}
